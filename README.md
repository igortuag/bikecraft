...
Para isso foi criado um [briefing da Bikcraft](./planejamento/briefing.md) no planejamento. Após isso foi feita e montada a [arquitetura](./planejamento/information-architecture.md) do site.
